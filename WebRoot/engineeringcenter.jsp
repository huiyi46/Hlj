...
<html>
  ...
  <body onload="generateMap('servlet/FindEngineeringCenterAction','map','normal');">
    <h2 style="width:100%;text-align:center;font-size:36px;background:#e0e0e0;">黑龙江省工程中心分布</h2>
