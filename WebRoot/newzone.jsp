...
<html>
  ...
  <body onload="generateMap('servlet/FindNewZoneAction','map','big');">
    <h2 style="width:100%;text-align:center;font-size:36px;background:#e0e0e0;">黑龙江省高新区分布</h2>
