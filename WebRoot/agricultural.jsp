...
<html>
  ...
  <body onload="generateMap('servlet/FindAgriculturalAction','map','normal');">
    <h2 style="width:100%;text-align:center;font-size:36px;background:#e0e0e0;">黑龙江省农业科技园区分布</h2>
